...
<body>
    ...
    <main class="container-fluid d-flex">
        <div class="col-3">
            <div class="row">
                ...
                <div class="col">
                    @include('client.layout.filterCards.selectedBrands')
                    @include('client.layout.filterCards.category')
                    <!-- üstteki category cartında category seçilince category'e ait ilgili alanların display'leri none'dan block oluyor.-->
    ...
    <script>
        function getOtherFilter(category_id) {
            ...
            const checkbox = document.getElementById(category_id);
            if (checkbox.checked) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function applyFilters() {
                ...
                const brand = document.querySelector('#bodyDiv2 input');
                formData.append(brand.dataset.key, brand.dataset.value);
